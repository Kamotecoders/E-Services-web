        ...
        <div class="col-3 text-end text-white d-flex align-items-center justify-content-end">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item hover d-flex align-items-center justify-content-start gap-2"
                            href="../logout.html"><span class="material-symbols-outlined">logout</span> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div style="
      ...
      " class="container-fluid p-4 text-center">
        ...
        <div class="row justify-content-center mt-4 gap-3">
            <a href="./voters_certificate.html" style="box-shadow: 1px 0px 5px 9px rgba(255,255,255,0.6) inset;"
            ...
            <a href="./PSA.html" style="box-shadow: 1px 0px 5px 9px rgba(255,255,255,0.6) inset;"
        ...
        <div class="row justify-content-center mt-4 gap-3">
            <a href="./kasalang Bayan.html" style="box-shadow: 1px 0px 5px 9px rgba(255,255,255,0.6) inset;"
                class="col border-0 btn col-md-3 p-4 text-center text-white bg-success">
                <img src="https://cdn0.iconfinder.com/data/icons/valentines-day-4/345/couple-512.png"
                    class="rounded-circle border" style="height: 150px; width: 150px;" alt="voters certificate"><br><br>
                <h4>kasalang Bayan</h4>
            </a>
            <a href="./Burrial Assistance.html" style="box-shadow: 1px 0px 5px 9px rgba(255,255,255,0.6) inset;"
                class="col border-0 btn col-md-3 p-4 text-center text-white bg-success ">
